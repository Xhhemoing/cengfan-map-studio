...
import { assertHardConstraints, bounds, cardInput } from "./card-layout-test-fixtures";

// The proximity/columns modes, the connector-crossing constraint and the
// element-overlap switch live in `card-layout.modes-extra.test.ts`.
