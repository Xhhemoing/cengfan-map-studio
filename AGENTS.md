...
本仓库只存放编辑器程序,以及使用者/开发者运行与贡献所需的文档。不要提交:

- 本地 AI agent 会话、learnings、superpowers 计划、graphify 分析产物、本机绝对路径
- 真实学生名单、API 密钥、服务器 IP、管理员密码
- 宣发投放、KOL 合同、私域群运营等与程序本体无关的材料
